...
!(function (t, e) {
    ...
    var e = {
        ...
        hsv2hsl: function (t) {
            var e,
                ...
                o = t[2] / 100;
            return (
                (e = a * o), [n, 100 * (e = (e /= (i = (2 - a) * o) <= 1 ? i : 2 - i) || 0), 100 * (i /= 2)]
            );
        },
        hsv2hwb: function (t) {
            return a(h(t));
    ...
    st._set("global", {
        elements: {
            rectangle: {backgroundColor: Ft, borderColor: Ft, borderSkipped: "bottom", borderWidth: 0},
        },
    });
    var Nt = pt.extend({
            draw: function () {
    ...
    var ne = Mt.extend({
            ...
            update: function (t) {
                ...
                for (
                    d && 0 !== o._model.tension && n.updateBezierControlPoints(), e = 0, i = r.length;
                    e < i;
                    ++e
                )
                    r[e].pivot();
    ...
    function Ki(t, e) {
        ...
        return (
            ...
            null !== r
                ? +r
                : (a || "function" != typeof o || ((r = o(e)), ut.isFinite(r) || (r = i.parse(r))), r)
        );
    }
    function Gi(t, e) {
    ...
    var Ji = fi.extend({
            ...
            determineDataLimits: function () {
                ...
                p.length &&
                    ((p = Ui(p).sort(Yi)), (h = Math.min(h, p[0])), (c = Math.max(c, p[p.length - 1]))),
                    f.length &&
                        ((f = Ui(f).sort(Yi)), (h = Math.min(h, f[0])), (c = Math.max(c, f[f.length - 1]))),
                    (h = Gi(r, d.min) || h),
                    (c = Gi(r, d.max) || c),

  ...
  compute it */
    ...
    var core_scale = core_element.extend({
            ...
            if (tickOpts.display && display) {
                ...
                if (isHorizontal) {
                    ...
                    if (me.labelRotation !== 0) {
                        paddingLeft =
                            position === "bottom" ? cosRotation * firstLabelWidth : cosRotation * lineSpace;
                        paddingRight =
                            position === "bottom" ? cosRotation * lineSpace : cosRotation * lastLabelWidth;
                    } else {
        ...
        draw: function (chartArea) {
            ...
            var parseFont = helpers$1.options._parseFont;
            var ticks =
                optionTicks.display && optionTicks.autoSkip ? me._autoSkip(me.getTicks()) : me.getTicks();
    ...
    var scale_time = core_scale.extend({
        ...
        buildTicks: function () {
            ...
            // PRIVATE
            me._unit =
                timeOpts.unit || determineUnitForFormatting(me, ticks, timeOpts.minUnit, me.min, me.max);
        ...
        getValueForPixel: function (pixel) {
            ...
            var pos =
                (size ? (pixel - start) / size : 0) * (me._offsets.start + 1 + me._offsets.start) -
                me._offsets.end;
            ...
            if (display) {
                ...
                if (isHorizontal) {
                    ...
                    helpers$1.each(me.legendItems, function (legendItem, i) {
                        ...
                        if (
                            i === 0 ||
                            lineWidths[lineWidths.length - 1] + width + labelOpts.padding > minSize.width
                        ) {
                ...
                helpers$1.each(me.legendItems, function (legendItem, i) {
                    ...
                    if (isHorizontal) {
                        if (i > 0 && x + width + labelOpts.padding > me.left + me.minSize.width) {
                            ...
                            cursor.line++;
                            x = cursor.x =
                                me.left + (legendWidth - lineWidths[cursor.line]) / 2 + labelOpts.padding;
                        }

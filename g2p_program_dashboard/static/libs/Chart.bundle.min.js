...
!(function (t, e) {
    ...
    var t = {
        ...
        hsv2hsl: function (t) {
            var e,
                ...
                r = t[2] / 100;
            return (
                (e = a * r), [n, 100 * (e = (e /= (i = (2 - a) * r) <= 1 ? i : 2 - i) || 0), 100 * (i /= 2)]
            );
        },
        hsv2hwb: function (t) {
            return n(d(t));
            ...
            advance: function () {
                for (var t, e, i, n, a = this.animations, r = 0; r < a.length; )
                    (e = (t = a[r]).chart),
                        ...
                        t.currentStep >= i
                            ? (ut.callback(t.onAnimationComplete, [t], e), (e.animating = !1), a.splice(r, 1))
                            : ++r;
            },
        },
    ...
    var Ot = gt.extend({
            inRange: function (t, e) {
                var i = this._view;
                return (
                    !!i && Math.pow(t - i.x, 2) + Math.pow(e - i.y, 2) < Math.pow(i.hitRadius + i.radius, 2)
                );
            },
            inLabelRange: Tt,
            inXRange: Tt,
    ...
    ot._set("global", {
        elements: {
            rectangle: {backgroundColor: It, borderColor: It, borderSkipped: "bottom", borderWidth: 0},
        },
    });
    var Yt = gt.extend({
            draw: function () {
            ...
            getCenterPoint: function () {
                var t,
                    ...
                    i = this._view;
                return (
                    At(i) ? ((t = i.x), (e = (i.y + i.base) / 2)) : ((t = (i.x + i.base) / 2), (e = i.y)),
                    {x: t, y: e}
                );
            },
            getArea: function () {
        ...
        update: function (t) {
            ...
            for (
                a.borderWidth = n.getMaxBorderWidth(),
                    ...
                    a.radiusLength =
                        (a.outerRadius - a.innerRadius) / (n._getVisibleDatasetWeightTotal() || 1),
    ...
    var ie = kt.extend({
            ...
            update: function (t) {
                ...
                for (
                    u && 0 !== r._model.tension && n.updateBezierControlPoints(), e = 0, i = o.length;
                    e < i;
                    ++e
                )
                    o[e].pivot();
    ...
    ut.extend(ni.prototype, {
        ...
        buildOrUpdateScales: function () {
            ...
            e.scales &&
                ...
                e.scale &&
                    n.push({options: e.scale, dtype: "radialLinear", isDefault: !0, dposition: "chartArea"}),
        ...
        gi = fi.extend({
            ...
            buildTicks: function () {
                var t = this,
                    e = t.getLabels();
                t.ticks =
                    0 === t.minIndex && t.maxIndex === e.length - 1 ? e : e.slice(t.minIndex, t.maxIndex + 1);
            },
    ...
    var Si = fi.extend({
            ...
            handleTickRangeOptions: function () {
                ...
                (t.min = Mi(e.min, t.min)),
                    ...
                    null === t.max &&
                        (t.max = 0 !== t.min ? Math.pow(10, Math.floor(ut.log10(t.min)) + 1) : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
                            : t.max < 1
    ...
    function Zi(t, e) {
        ...
        return (
            ...
            null !== o
                ? +o
                : (a || "function" != typeof r || ((o = r(e)), ut.isFinite(o) || (o = i.parse(o))), o)
        );
    }
    function $i(t, e) {
        ...
        for (
            d ||
                ...
                c &&
                    ...
                    !h &&
                    !s.round &&
                    ((a = +r.startOf(a, u)), (a = +r.add(a, ~~((g - a) / (f.size * d)) * d, l)));
            a < m;
            a = +r.add(a, d, l)
        )
            p.push(+a);
    ...
    var Ji = fi.extend({
            ...
            determineDataLimits: function () {
                ...
                m.length &&
                    ((m = Gi(m).sort(Ui)), (h = Math.min(h, m[0])), (c = Math.max(c, m[m.length - 1]))),
                    f.length &&
                        ((f = Gi(f).sort(Ui)), (h = Math.min(h, f[0])), (c = Math.max(c, f[f.length - 1]))),
                    (h = $i(o, u.min) || h),
                    (c = $i(o, u.max) || c),
                    ...
                    (n._unit =
                        ...
                        (function (t, e, i, n, a) {
                            ...
                            for (r = ji.length - 1; r >= ji.indexOf(i); r--)
                                if (((o = ji[r]), Bi[o].common && t._adapter.diff(a, n, o) >= e.length))
                                    return o;
                ...
                t.exports = (function () {
                    ...
                    function N(t, e, i) {
                        var n = "" + Math.abs(t),
                            ...
                            r = t >= 0;
                        return (
                            (r ? (i ? "+" : "") : "-") + Math.pow(10, Math.max(0, a)).toString().substr(1) + n
                        );
                    }
                    ...
                    (bi.add = Je),
                        ...
                        (bi.hasAlignedHourOffset = function (t) {
                            return (
                                !!this.isValid() &&
                                ((t = t ? Ie(t).utcOffset() : 0), (this.utcOffset() - t) % 60 == 0)
                            );
                        }),
                        (bi.isDST = function () {
                            return (
                    ...
                    return (
                        ...
                        (n.relativeTimeThreshold = function (t, e) {
                            return (
                                void 0 !== $i[t] &&
                                (void 0 === e ? $i[t] : (($i[t] = e), "s" === t && ($i.ss = e - 1), !0))
                            );
                        }),
        ...
        "function" == typeof nn
            ? {
                  ...
                  startOf: function (t, e, i) {
                      return (
                          (t = nn(t)), "isoWeek" === e ? t.isoWeekday(i).valueOf() : t.startOf(e).valueOf()
                      );
                  },
                  endOf: function (t, e) {
    ...
    ot._set("global", {
        ...
        legendCallback: function (t) {
            ...
            for (var i = 0; i < t.data.datasets.length; i++)
                e.push(
                    '<li><span style="background-color:' + t.data.datasets[i].backgroundColor + '"></span>'
                ),
